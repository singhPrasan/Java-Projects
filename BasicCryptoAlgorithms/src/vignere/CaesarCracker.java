...
public class CaesarCracker {
    ...
    public static void main(String[] args) {
		CaesarCracker ccv = new CaesarCracker('a');
		FileResource fr = new FileResource("data/VigenereTestData/oslusiadas_key17.txt");
		System.out.println(ccv.decrypt(fr.asString()));
	}
