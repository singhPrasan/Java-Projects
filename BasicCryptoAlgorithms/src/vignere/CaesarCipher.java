...
public class CaesarCipher {
    ...
    public static void main(String[] args) {
		CaesarCipher ccv = new CaesarCipher(5);
		FileResource fr = new FileResource("data/VigenereTestData/titus-small.txt");
		String encryptedText = ccv.encrypt(fr.asString());
		System.out.println(encryptedText);
		System.out.println("Decrypted text : \n"+ccv.decrypt(encryptedText));
